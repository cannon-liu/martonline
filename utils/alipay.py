...
class AliPay(object):
    ...
    def sign_data(self, data):
        ...
        #将排序后的参数与其对应值，组合成“参数=参数值”的格式，并且把这些参数用&字符连接起来，生成的字符串为待签名字符串。
...
if __name__ == "__main__":
    ...
    alipay = AliPay(
        ...
        # 支付宝的公钥
        alipay_public_key_path="../apps/trade/keys/alipay_2048.txt",  # 支付宝的公钥，验证支付宝回传消息使用
